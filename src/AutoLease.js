        ...
        <Box sx={{ p: "20px" }}>
          {eligibalBank === "your not eligibale for any Bank" ? (
            ...
            <Alert severity="success">
              ...
              <a
                href={
                  eligibalBank === "Riyad Bank click here for apply now."
                    ? "https://www.riyadbank.com/personal-banking/car-loan"
                    : eligibalBank ===
                      "Arab national Bank click here for apply now."
                    ? "https://anb.com.sa/web/anb/auto-lease"
                    : "alahli.com/en-us/personal-banking/ncb_offers/pages/alahli-lease-finance.aspx"
                }
                target="_blank"
