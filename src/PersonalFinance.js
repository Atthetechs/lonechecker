        ...
        <Box sx={{ p: "20px" }}>
          {eligibalBank === "your not eligibale for any Bank" ? (
            ...
            <Alert severity="success">
              You are eligible for <space />
              <a
                href={
                  eligibalBank === "Riyad Bank"
                    ? "http://www.riyadbank.com/personal-banking/personal-finance"
                    : eligibalBank === "Arab national Bank"
                    ? "https://anb.com.sa/web/anb/personal"
                    : "https://www.alahli.com/en-us/personal-banking/islamic-Finance/pages/alahli-personal-finance.aspx"
                }
                target="_blank"
